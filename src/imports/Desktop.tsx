import svgPaths from "./svg-bgfs50cta0";
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col items-start pb-[20px] pt-0 px-[20px] relative w-full">
          <div aria-hidden="true" className="aspect-[1218.57/172.131] relative shrink-0 w-full" data-name="Grain Archive Logo" role="presentation">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1220 173">
...
function ArticlesItem() {
  return (
    <article className="basis-0 grow h-[700px] min-h-px min-w-[600px] relative rounded-[8px] shrink-0" data-name="Articles item">
      <div className="flex flex-col items-center justify-end min-w-inherit overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col h-[700px] items-center justify-end min-w-inherit p-[10px] relative w-full">
...
function ButtonLarge() {
  return (
    <button aria-label="View all articles" className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left cursor-pointer from-[#ffffff] min-w-[800px] relative rounded-[8px] shrink-0 to-[#ffffff] w-full" data-name="Button - large" style={{ backgroundImage: `url('${imgButtonLarge}')` }}>
      <div className="flex flex-row items-center justify-center min-w-inherit size-full">
        <div className="box-border content-stretch flex items-center justify-center min-w-inherit px-[24px] py-[32px] relative w-full">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Album display">
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[32px] items-center px-[200px] py-0 relative w-full">
...
function FeaturedAlbumSection() {
  return (
    <section className="relative rounded-[8px] shrink-0 w-full" data-name="Featured album section">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col items-center pb-[60px] pt-[290px] px-[10px] relative w-full">
          <h2 className="absolute block font-['Tilt_Warp:Regular',sans-serif] leading-[0.8] left-[10px] max-w-[1000px] text-[#f6f8fb] text-[160px] top-[60px] tracking-[-8px] w-[800px]" style={{ fontVariationSettings: "'XROT' 0, 'YROT' 0" }}>
            Featured Album
          </h2>
          <AlbumDisplay />
        </div>
    ...
    <section className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left from-[#f5f5f5] relative rounded-[8px] shrink-0 to-[#f5f5f5] w-full" data-name="Cinema selects section" style={{ backgroundImage: `url('${imgCinemaSelectsSection}')` }}>
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[80px] items-start px-[10px] py-[60px] relative w-full">
          <h2 className="block font-['Tilt_Warp:Regular',sans-serif] leading-[0.8] relative shrink-0 text-[#0f0e0e] text-[160px] tracking-[-8px] w-[800px]" style={{ fontVariationSettings: "'XROT' 0, 'YROT' 0" }}>
            Cinema Selects
          </h2>
          <Content4 />
        </div>
...
function LinkList() {
  return (
    <div className="content-stretch flex flex-col font-['Geist:Regular',sans-serif] font-normal items-end leading-[1.4] relative shrink-0 text-[#d1d2d8] text-[20px] text-nowrap text-right tracking-[-0.4px] underline w-full whitespace-pre" data-name="Link list">
...
function LinkList1() {
  return (
    <div className="content-stretch cursor-pointer flex flex-col font-['Geist:Regular',sans-serif] font-normal items-end leading-[1.4] relative shrink-0 text-[#d1d2d8] text-[20px] text-nowrap text-right tracking-[-0.4px] underline w-full whitespace-pre" data-name="Link list">
...
function FooterContent() {
  return (
    <div className="content-stretch flex flex-col gap-[100px] items-end relative shrink-0" data-name="Footer content">
      <FooterLinks />
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-end leading-[1.4] min-w-full relative shrink-0 text-[#d1d2d8] text-[16px] text-right tracking-[-0.32px] w-[min-content]">
  ...
  return (
    <footer className="relative shrink-0 w-full z-[1]" data-name="Footer">
      <div className="flex flex-row items-end justify-center size-full">
        <div className="box-border content-stretch flex gap-[40px] items-end justify-center pb-[20px] pt-[120px] px-[20px] relative w-full">
          <div className="basis-0 flex flex-col font-['Tilt_Warp:Regular',sans-serif] grow justify-end leading-[0] min-h-px min-w-px relative shrink-0 text-[#f6f8fb] text-[200px] tracking-[-8px]" style={{ fontVariationSettings: "'XROT' 0, 'YROT' 0" }}>
            <h2 className="block leading-[0.85]">
              Grain
              <br aria-hidden="true" />
              Archive
            </h2>
...
export default function Desktop() {
  return (
    <div className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left content-stretch flex flex-col from-[#0f0e0e] isolate items-center relative size-full to-[#0f0e0e]" data-name="Desktop" style={{ backgroundImage: `url('${imgButtonSmall}')` }}>
