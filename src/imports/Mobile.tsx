import svgPaths from "./svg-z2ah4fdtgw";
...
function NavItem() {
  return (
    <button aria-label="Navigate to homepage" className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left box-border content-stretch flex from-[#ff5700] items-center justify-center px-[12px] py-[8px] relative shrink-0 to-[#ff5700]" data-name="Nav item" style={{ backgroundImage: `url('${imgNavItem}')` }}>
      <p className="font-['Geist:SemiBold',sans-serif] font-semibold leading-[1.4] relative shrink-0 text-[#0f0e0e] text-[18px] text-nowrap tracking-[-0.36px] whitespace-pre">Home</p>
    </button>
  );
}
...
function NavItem1() {
  return (
    <button aria-label="Browse article archive" className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left box-border content-stretch flex from-[#32ce57] items-center justify-center px-[12px] py-[8px] relative rounded-[999px] shrink-0 to-[#32ce57]" data-name="Nav item" style={{ backgroundImage: `url('${imgNavItem1}')` }}>
      <p className="font-['Geist:SemiBold',sans-serif] font-semibold leading-[1.4] relative shrink-0 text-[#0f0e0e] text-[18px] text-nowrap tracking-[-0.36px] whitespace-pre">Archive</p>
    </button>
  );
}
...
function NavItem2() {
  return (
    <button aria-label="Learn more about Grain Archive" className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left box-border content-stretch flex from-[#a3caff] items-center justify-center px-[12px] py-[8px] relative rounded-[6px] shrink-0 to-[#a3caff]" data-name="Nav item" style={{ backgroundImage: `url('${imgNavItem2}')` }}>
      <p className="font-['Geist:SemiBold',sans-serif] font-semibold leading-[1.4] relative shrink-0 text-[#0f0e0e] text-[18px] text-nowrap tracking-[-0.36px] whitespace-pre">About</p>
    </button>
  );
}
...
function Links() {
  return (
    <div className="basis-0 content-center cursor-pointer flex flex-wrap gap-[8px] grow items-center justify-center min-h-px min-w-px relative shrink-0" data-name="Links">
      <NavItem />
      <NavItem1 />
      <NavItem2 />
    </div>
...
function Navigation() {
  return (
    <nav className="box-border content-stretch flex items-start justify-center pb-0 pointer-events-auto pt-[10px] px-0 sticky top-0 z-[5]" data-name="Navigation">
      <Links />
    </nav>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Logo container">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col items-start pb-[10px] pt-0 px-[10px] relative w-full">
          <div aria-hidden="true" className="aspect-[1218.57/172.131] relative shrink-0 w-full" data-name="Grain Archive Logo" role="presentation">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 335 48">
...
function HeroSection() {
  return (
    <header className="box-border content-stretch flex flex-col h-[640px] items-center justify-end p-0 relative rounded-[8px] shrink-0 w-full" data-name="Hero section">
      ...
      <h1 className="block font-['Geist:SemiBold',sans-serif] font-semibold h-[25px] leading-[1.4] relative shrink-0 text-[20px] text-[rgba(255,255,255,0)] text-center tracking-[-0.4px] w-[112px]">Grain Archive</h1>
      <LogoContainer />
    </header>
  );
}
  ...
  return (
    <article className="h-[460px] relative rounded-[8px] shrink-0 w-full" data-name="Articles item">
      <div className="flex flex-col items-center justify-end overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col h-[460px] items-center justify-end p-[10px] relative w-full">
...
function ArticlesList() {
  return (
    <section className="box-border content-stretch flex flex-col gap-[10px] items-center p-0 relative shrink-0 w-full" data-name="Articles list">
      <ArticlesItem />
      <ArticlesItem1 />
      <ArticlesItem2 />
      <ArticlesItem3 />
...
function ButtonLarge() {
  return (
    <button aria-label="View all articles" className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left cursor-pointer from-[#ffffff] relative rounded-[8px] shrink-0 to-[#ffffff] w-full" data-name="Button - large" style={{ backgroundImage: `url('${imgButtonLarge}')` }}>
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex items-center justify-center px-[24px] py-[16px] relative w-full">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Album display">
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[32px] items-center px-[40px] py-0 relative w-full">
...
function FeaturedAlbumSection() {
  return (
    <section className="relative rounded-[8px] shrink-0 w-full" data-name="Featured album section">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col items-center pb-[40px] pt-[155px] px-[10px] relative w-full">
          <h2 className="absolute block font-['Tilt_Warp:Regular',sans-serif] leading-[0.8] left-[10px] max-w-[360px] text-[#f6f8fb] text-[160px] top-[60px] tracking-[-8px] w-[335px]" style={{ fontVariationSettings: "'XROT' 0, 'YROT' 0" }}>
            Featured Album
          </h2>
          <AlbumDisplay />
        </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Labels">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex font-['Geist:SemiBold',sans-serif] font-semibold gap-[16px] items-center leading-[1.4] pl-0 pr-[10px] py-0 relative text-[#0f0e0e] text-[20px] tracking-[-0.4px] w-full">
          <p className="basis-0 grow min-h-px min-w-px opacity-60 relative shrink-0">Film</p>
          <p className="opacity-60 relative shrink-0 text-right w-[160px]">Year</p>
        </div>
      </div>
    </div>
  );
...
function CinemaSelectsItem() {
  return (
    <div className="box-border content-stretch flex gap-[16px] items-start px-0 py-[16px] relative shrink-0 w-full" data-name="Cinema selects item">
      ...
      <p className="basis-0 font-['Geist:SemiBold',sans-serif] font-semibold grow leading-[1.4] min-h-px min-w-px relative shrink-0 text-[#0f0e0e] text-[20px] text-right tracking-[-0.4px]">2023</p>
    </div>
  );
}
...
function CinemaSelectsSection() {
  return (
    <section className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left from-[#f5f5f5] relative rounded-[8px] shrink-0 to-[#f5f5f5] w-full" data-name="Cinema selects section" style={{ backgroundImage: `url('${imgCinemaSelectsSection}')` }}>
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[80px] items-start px-[10px] py-[40px] relative w-full">
          <h2 className="block font-['Tilt_Warp:Regular',sans-serif] leading-[0.8] max-w-[360px] relative shrink-0 text-[#0f0e0e] text-[160px] tracking-[-8px] w-full" style={{ fontVariationSettings: "'XROT' 0, 'YROT' 0" }}>
            Cinema Selects
          </h2>
          <Content4 />
        </div>
  ...
  return (
    <main className="max-w-[1800px] relative shrink-0 w-full z-[3]" data-name="Body content container" tabIndex="-1">
      <div className="flex flex-col items-center justify-center max-w-inherit size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-center justify-center max-w-inherit px-[10px] py-0 relative w-full">
          <HeroSection />
          <ArticlesList />
          <ButtonLarge />
...
function Holes() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0" data-name="Holes">
      <div className="size-full">
        <div className="box-border content-stretch flex items-start justify-between px-[20px] py-[16px] relative size-full">
...
function PaperGraphics() {
  return (
    <div className="content-stretch flex h-[52px] items-center relative shrink-0 w-full" data-name="Paper graphics 1">
      <div aria-hidden="true" className="absolute border-[#0f0e0e] border-[0px_0px_1.5px] border-dashed inset-0 pointer-events-none" />
      <Holes />
    </div>
  );
}
...
function ButtonSmall() {
  return (
    <a className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left box-border content-stretch cursor-pointer flex from-[#0f0e0e] h-[56px] items-center justify-center px-[16px] py-0 relative shrink-0 to-[#0f0e0e]" data-name="Button - small" href="https://www.figma.com/sites/" style={{ backgroundImage: `url('${imgButtonSmall}')` }}>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[32px] items-center justify-center px-[40px] py-0 relative w-full">
          <Paragraph />
          <ButtonSmall />
        </div>
      </div>
...
function PaperGraphics1() {
  return (
    <div className="content-stretch flex h-[52px] items-center relative shrink-0 w-full" data-name="Paper graphics 2">
      <div aria-hidden="true" className="absolute border-[#0f0e0e] border-[1.5px_0px_0px] border-dashed inset-0 pointer-events-none" />
      <Holes1 />
    </div>
  );
}
  ...
  return (
    <aside className="relative shrink-0 w-full z-[2]" data-name="Subscribe section">
      ...
      <div className="flex flex-col items-center justify-end size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-end pb-[40px] pt-[180px] px-[40px] relative w-full">
          <SubscribeContainer />
        </div>
      </div>
    </aside>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Logo container">
      <div className="aspect-[1218.57/172.131] relative shrink-0 w-full" data-name="Grain Archive Logo">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 335 48">
          <path d={svgPaths.p92fc000} fill="var(--fill-0, #F6F8FB)" id="Grain Archive Logo" />
        </svg>
      </div>
    </div>
  );
...
function LinksColumn() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[6px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Links column">
      <Label />
      <LinkList />
    </div>
  );
...
function ConnectColumn() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[6px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Connect column">
      <Label1 />
      <LinkList1 />
    </div>
  );
...
function FooterContent() {
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-start relative shrink-0 w-full" data-name="Footer content">
      <FooterLinks />
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-end leading-[1.4] relative shrink-0 text-[#d1d2d8] text-[16px] tracking-[-0.32px] w-full">
...
export default function Mobile() {
  return (
    <div className="bg-gradient-to-r bg-repeat bg-size-[1280px_600px,auto] bg-top-left content-stretch flex flex-col from-[#0f0e0e] isolate items-center relative size-full to-[#0f0e0e]" data-name="Mobile" style={{ backgroundImage: `url('${imgButtonSmall}')` }}>
